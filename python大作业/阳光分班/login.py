...
class FramelessWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        palette1.setBrush(self.backgroundRole(), QtGui.QBrush(
            QtGui.QPixmap('images/1.jpg')))  # 设置登录背景图片
...
if __name__ == '__main__':
    ...
    mainWnd.setFixedSize(QSize(690,517))  #因为这里固定了大小，所以窗口的大小没有办法任意调整，想要使resizeWidget函数生效的话要把这里去掉，自己调节布局和窗口大小
